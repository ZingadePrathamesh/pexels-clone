            ...
            <header className="text-white md:py-4 py-1">
                <div className="container mx-auto text-center md:w-[40vw]">
                    ...
                    <div className="mt-4 flex justify-center items-center">
                        <input type="text" className="p-2 w-64 border border-gray-300 rounded-l focus:outline-none" onChange={setInputValue(event.target.value)} placeholder="Search for free photos" />
                        <button onClick={search()} className="bg-blue-500 text-white p-2 rounded-r">Search</button>
                    </div>
                </div>
            </header>
            <div className="container mx-auto mt-8">
                <div className="text-center" id='trending'>
